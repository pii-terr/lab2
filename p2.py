...
driver.find_element(By.XPATH ,'//*[@id="Email"]').send_keys("wellehugroiqui-2886@yopmail.com")
...
driver.find_element(By.XPATH ,'//*[@id="EmailLogin"]').send_keys("wellehugroiqui-2886@yopmail.com")
